...
/// HANDLES END //////////////////////////////////////////////////////////////////
    ...
    <div className="SearchBar-fields">
        <input onChange={this.handleTermChange} placeholder="Search (Pizza, Mcdonalds, Disney)" />
        <input onChange={this.handleLocationChange} placeholder="Where? (Sacramento, NY, LA)" />
    </div>
